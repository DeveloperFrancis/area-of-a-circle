...
<head>
    ...
    <title>Admin Dashboard - Prison Registration System</title>
    <style>
        body {
...
<body>
    <div class="header">Prison Registration System - Admin Dashboard</div>

    <div class="sidebar">
        <a href="#">Dashboard</a>
        <a href="admin_prisoners_management.php">Prisoners Details</a>
        <a href="admin_visit_management.php">View Visits</a>
        <a href="add_users.php">Add and Manage Users</a> 
