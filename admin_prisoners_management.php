...
<body>
    ...
    <div class="container">
        ...
        <table> 
            ...
            <tr>
                ...
                <td>
                    <a href="admin_edit_prisoner.php?id=<?= $row['prisoner_id']; ?>" class="btn edit-btn">Edit</a>
                    <a href="admin_delete_prisoner.php?id=<?= $row['prisoner_id']; ?>" class="btn delete-btn" onclick="return confirm('Are you sure you want to delete this record?');">Delete</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </table>
    ...
    <div>
        <a href="adminhomepage.php" class="logout-btn">Home</a>
    </div>
